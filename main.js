...
let questions = [{
        question: "By area, which continent is the largest in the world?",
        options: [
            "Africa",
            "Asia",
            "Europe",
    ...
    {
        question: "What completes the saying ''It takes two to _______''?",
        options: [
            "Love",
            "Tango",
            "Waltz",
    ...
    {
        question: "What philosopher coined the phrase ''God is dead''?",
        options: [
            "Immanuel Kant",
            "Blaise Pascal",
            "Rene Descartes",
    ...
    {
        question: "George Harrison and Ringo Starr were members of which band?",
        options: [
            "The Beatles",
            "U2",
            "The Animals",
...
function quizOver() {
    ...
    if (scoreCounter <= 2) {
        quizOverText1.innerHTML = 'Nice!';
        quizOverText2.innerHTML = 'You Scored ' + scoreCounter;
    } else if (scoreCounter <= 4) {
        quizOverText1.innerHTML = 'Awesome!';
        quizOverText2.innerHTML = 'You Scored ' + scoreCounter;
    } else {
        quizOverText1.innerHTML = 'Perfect!';
        quizOverText2.innerHTML = 'You Scored ' + scoreCounter;
    }
}
